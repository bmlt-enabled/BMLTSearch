...
- **Domain logic extracted and tested** — time arithmetic, meeting classification, grouping, filtering, the service body tree, marker clustering, and the share payload now live framework-free in `src/lib/meetings/` under 132 unit tests
